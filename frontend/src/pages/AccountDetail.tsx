...
export function AccountDetail() {
  ...
  return (
    <div>
      <PageHeader eyebrow="Accounts -> Account Overview" title={account.name} description="Overview, health, stage, opportunities, governance, notes, and timeline in one workspace." />
