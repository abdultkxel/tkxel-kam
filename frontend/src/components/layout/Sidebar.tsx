import { BriefcaseBusiness, Building2, CalendarDays, ChevronLeft, Home, ListChecks, PlaySquare, RefreshCcw, Settings, ShieldAlert, UserRound } from 'lucide-react'
...
export const sidebarLinks: { to: string; label: string; icon: LucideIcon; privileged?: boolean }[] = [
  ...
  { to: '/retention', label: 'Retention', icon: RefreshCcw },
