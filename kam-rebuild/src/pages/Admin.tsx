...
import { BellRing, CheckCircle2, Download, PlugZap, Plus, Save, ShieldCheck, SlidersHorizontal } from 'lucide-react'
...
const adminSections = [
  { id: 'accounts', label: 'Accounts import' },
...
export function Admin() {
  ...
  const highlightedSection = activeSection || 'accounts'
  ...
  return (
    <div>
      <PageHeader
        ...
        title="Admin"
        description="Account import, scoring, timeline policies, integrations, notification settings, and audit controls."
        actions={(
          <>
