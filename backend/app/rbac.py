...
DEFAULT_ROLES: tuple[DefaultRole, ...] = (
    ...
    DefaultRole(
        ...
        permission_rules=(
            ...
            ("stakeholder_relationship", CONFIG_ACTIONS),
            ("account_planning", CONFIG_ACTIONS),
            ("opportunity_management", CONFIG_ACTIONS),
            ("retention_stability", CONFIG_ACTIONS),
            ...
            ("handover_summary", CONFIG_ACTIONS + ("export",)),
            ("ai_assistance_search", CONFIG_ACTIONS + ("export",)),
            ("dashboards_reporting", CONFIG_ACTIONS),
            ("analytics_portfolio", ("view", "update", "configure", "export")),
        ),
    ),
    DefaultRole(
    ...
    DefaultRole(
        ...
        + (
            ("stakeholder_relationship", LEADERSHIP_ACTIONS + ("configure",)),
            ("account_planning", LEADERSHIP_ACTIONS + ("configure",)),
            ("opportunity_management", LEADERSHIP_ACTIONS + ("configure",)),
            ("retention_stability", LEADERSHIP_ACTIONS + ("configure",)),
            ("kyc", ("configure",)),
            ("scoring_engine", CONFIG_ACTIONS),
            ("signals_attention", CONFIG_ACTIONS),
            ("playbooks_tasks_calendar", CONFIG_ACTIONS),
            ("notifications_digests", CONFIG_ACTIONS),
            ("integrations", ("view", "create", "update", "configure")),
            ("dashboards_reporting", ("view", "configure", "export")),
            ("analytics_portfolio", ("view", "update", "export")),
